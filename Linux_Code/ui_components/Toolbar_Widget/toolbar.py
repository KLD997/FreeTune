...
class ToolbarWidget(QWidget):
    def __init__(self, ui):
        ...
        toolbar = QToolBar("Main ToolbarWidget")
        ...
        col_icons = [
            ('More columns (M)', QIcon(self.resource_path("ui_components/Toolbar_Widget/col_add.png")), "Col+"),
            ('Less columns (W)', QIcon(self.resource_path("ui_components/Toolbar_Widget/col_remove.png")), "Col-"),
            ('Shift Columns (+)', QIcon(self.resource_path("ui_components/Toolbar_Widget/shift_col+.png")), "Shift+"),
            ('Shift Columns (-)', QIcon(self.resource_path("ui_components/Toolbar_Widget/shift_col-.png")), "Shift-"),
        ]
